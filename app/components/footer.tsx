      ...
      <div className="container mx-auto px-6 py-8 flex flex-wrap justify-between items-center">
        ...
        <div className="flex flex-col space-y-2">
          <div className="flex space-x-4">
            <Link href={profiles.github}><Github className="h-5 w-5" /></Link>
            <Link href={profiles.upwork}><Upwork className="h-5 w-5" /></Link>
            <Link href={profiles.linkedin}><Linkedin className="h-5 w-5" /></Link>
            <Link href={profiles.instagram}><InstagramIcon className="h-5 w-5" /></Link>
          </div>
        </div>
      </div>
    </footer>
